...
myModel <- setParams(myModel, lambda=0.5, beta=1.0)
...
Test whether two cases are in the same cluster:
```{r}
withinCluster(N = 3, k_cutoff = 5, t1 = 2012.13, t2 = 2015.76, lambda = 0.7, beta = 1.3, perc_cutoff = 0.2)
```

I will add some visualisations using iGraph.

## Notes

More meaningful examples to come^[Under construction.].
